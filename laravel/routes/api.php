...
Route::middleware(['auth:sanctum'])->controller(StudentsController::class)->group(function () {
    Route::get('/students', 'index')->name(StudentsController::INDEX_ROUTE);
    Route::get('/students/{student}', 'show')->name(StudentsController::SHOW_ROUTE);
    ...
    Route::delete('/students/{student}', 'delete')->name(StudentsController::DELETE_ROUTE);
    Route::patch('/students/update-many', 'updateMany')->name(StudentsController::UPDATE_MANY_ROUTE);
    Route::patch('/students/{student}', 'update')->name(StudentsController::UPDATE_ROUTE);
});
